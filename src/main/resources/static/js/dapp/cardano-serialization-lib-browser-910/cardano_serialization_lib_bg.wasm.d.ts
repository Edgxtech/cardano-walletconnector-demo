...
export function transactionbuilder_set_prefer_pure_change(a: number, b: number): void;
export function transactionbuilder_new(a: number, b: number, c: number, d: number, e: number, f: number): number;
